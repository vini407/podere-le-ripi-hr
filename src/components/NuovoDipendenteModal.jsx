...
const repartoLabel = { vigna:'Vigna', cantina:'Cantina', ospitalita:'Ospitalità', cucina:'Cucina', marketing:'Marketing', hr:'HR', amministrazione:'Amministrazione', altro:'Altro' }
